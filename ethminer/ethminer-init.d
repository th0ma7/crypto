...
VERSION=`$DAEMON -V | head -1 | awk '{print $NF}'`
case $VERSION in
...
#  0.14.* ) EXTRA_PARAM="-HWMON -P $STRATUMURL://0x$WALLET.$WORKER@$SERVERS:$SSLPORT -P $STRATUMURL://0x$WALLET.$WORKER@$FSERVERS:$SSLPORT --cl-parallel-hash $CLPARALLELHASH --cl-kernel 1";;
  0.14.* | 0.15.* ) EXTRA_PARAM="-HWMON -P $STRATUMURL://0x$WALLET.$WORKER@$SERVERS:$SSLPORT -P $STRATUMURL://0x$WALLET.$WORKER@$FSERVERS:$SSLPORT --cl-parallel-hash $CLPARALLELHASH --cl-kernel 1";;
esac
